...
There are CubicSDR scripts for the Raspberry Pi OS and Ubuntu MATE.  The compile time for either script is approximately 45 minutes.  The dependencies that CubicSDR needs include the wxWidgets librairies. Those librairies alone require a compile time of 35 minutes.
