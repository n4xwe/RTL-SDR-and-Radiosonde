...
librtlsdr-dev libfftw3-3 libfftw3-dev libatomic-ops-dev swig doxygen ||
...
cmake ../ -DCMAKE_BUILD_TYPE=Release -DwxWidgets_CONFIG_EXECUTABLE=~/Develop/wxWidgets-staticlib/bin/wx-config -DOTHER_LIBRARIES="-latomic"
